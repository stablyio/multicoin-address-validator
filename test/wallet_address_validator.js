...
describe("WAValidator.validate()", function () {
    describe("valid results", function () {
        ...
        it("should return true for correct Digibyte addresses", function () {
            ...
            valid(
                "dgb1q00002724tefpjkpn8mp233uyqwd8hnny55e0zg",
                "DGB",
                "prod"
            );
        ...
        it("should return true for correct Aeternity addresses", () => {
            ...
            valid(
                "ak_8QxnP9qXP3NpA4fskYZE7P1GfHzKZAMmoNuok7jJC5NqVYi21",
                "ae"
            );
        });
        ...
        it("should return true for correct Chia addresses", () => {
            valid(
                "xch16rdrw2lktf729jtz0kc0hjuzr65akgx9d56j74f0xfsemp08njuq2a4j5e",
                "xch"
            );
            valid(
                "xch1ed7yctrag8s5su35qs6pxjzfzwng9hnt3txd5gvkkr0rg9serq4sp9g6n5",
                "xch"
            );
            valid(
                "xch1w0mjfntrxz79uacsfarm4jukqegewcgzyduw8k9fcc70lnls24ms8gax6y",
                "xch"
            );
            // testnet
            valid(
                "txch16rdrw2lktf729jtz0kc0hjuzr65akgx9d56j74f0xfsemp08njuq86jy42",
                "xch"
            );
        });
        ...
        it("should return true for correct digitalbits addresses", function () {
            valid(
                "GAHTKNX226D5LRBOLKIHGIRZ5CDLEV6LT2Z3GBNWU6ASW7DLSI7HC6CG",
                "digitalbits"
            );
            valid(
                "GBJRD43O3CHV4T5ILK7ITB722E42PSAANL33F4NI47PVF5TNXI4FUXSS",
                "xdb"
            );
            valid(
                "GBVI4U5B6R6W25KQG5OONKSFSCF4PESMFUDVIN5KAZAVXP2WC3ZWONWT",
                "xdb"
            );
            valid(
                "GA7X22PK5M3EWRKKODPPGCLLGVUQK32IIMD2F3XDSXUTEGORJKCLMP2H",
                "xdb",
                "testnet"
            );
            valid(
                "GC2W627ONUU23SSO3H4FKAAESEGRAVZMVI2YIG7LAYSHYVOLWEHT6QYS",
                "xdb",
                "testnet"
            );
        });

        it("should return true for correct polymesh addresses", function () {
            valid(
        ...
        it("should return true for correct Coreum addresses", function () {
            ...
            valid("testcore1un00l6nzdg58htj6e9fmx24433srcxpgdft57e", "coreum", "testnet");
        });
    });
    ...
    describe("invalid results", function () {
        ...
        it("should return false for incorrect polymesh addresses", function () {
            invalid("0x0c45E3bC8Bb52A67e2f6FF34De257DD887723933", "polymesh");
            invalid("0x0c45E3bC8Bb52A67e2f6FF34De257DD887723933", "polyx");
        });
    });
});
...
describe("invalid results", function () {
    ...
    it("should return false for incorrect Chia addresses", () => {
        ...
        invalid(
            "bnb1ed7yctrag8s5su35qs6pxjzfzwng9hnt3txd5gvkkr0rg9serq4sp9g6n5",
            "xch"
        );
        invalid(
            "thisisnotvalid0923492349239492349003jasdf90asd9adf92022123hnk3",
            "xch"
        );
        invalid(
            "txch16rdrw2lktf729jtz0kc0hjuzr65akgx9d56j74f0xfsemp08njuq2a4j5e",
            "xch"
        );
    });
